#Trabajo Práctico N3: Estructuras Condicionales
...
# 3) Escribir un programa que permita ingresar solo números pares. Si el usuario ingresa un número par, imprimir por pantalla el mensaje "Ha ingresado un número par"; 
...
if numero_ingresado % 2 == 0:
    ...
    print("El numero ingresado no es par, por favor intente nuevamente")
...
palabra = input("Ingrese una palabra o una frase de su gusto: ")
...
opcion = input("Ingrese 1 para MAYUS, 2 para MINUSC, o 3 para poner en MAYUS la PRIMER LETRA")
...
# 10) Escribir un programa que pregunte al usuario en cuál hemisferio se encuentra (N/S), qué mes del año es y qué día es. El programa deberá utilizar esa información para imprimir por pantalla si el usuario 
